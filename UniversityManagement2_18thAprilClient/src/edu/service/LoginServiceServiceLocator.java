...
public class LoginServiceServiceLocator extends org.apache.axis.client.Service implements edu.service.LoginServiceService {
    ...
    private java.lang.String LoginService_address = "http://localhost:8080/UniversityManagement2/services/LoginService";
    ...
    public edu.service.LoginService getLoginService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.service.LoginServiceSoapBindingStub _stub = new edu.service.LoginServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.service.LoginService.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.service.LoginServiceSoapBindingStub _stub = new edu.service.LoginServiceSoapBindingStub(new java.net.URL(LoginService_address), this);
                _stub.setPortName(getLoginServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.edu", "LoginServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.edu", "LoginService"));
        }
