	...
	--><div id="div1" class="form">
		<form name="form1" id="form1" class="form" method="post" action="AddInstructor">
			<table align="center" class="form" width="100%">
			    ...
			    <td align="left"><input type="text" id="fname" name="fname" size="25" title="Enter your first name"  onchange="isnotsplchar(this,'No special characters allowed') "></td>
			    </tr>
			    ...
			    <td align="left"><input type="text" id="lname" name="lname" size="25" title="Enter your last name"></td>
			    </tr>
			    ...
			    <td align="left"><input type="text" id="addr" name="addr" size="25" title="Enter your address"></td>
			    </tr>
			    ...
			    <td align="left"><input type="text" id="city" name="city" size="25" title="Enter City"></td>
			    </tr>
			    ...
			    <td align="left"><input type="text" id="state" name="state" size="25" title="Enter State" onchange="isstatevalid(this,'Invalid State')"></td>
			    </tr>
			    ...
			    <td align="left"><input type="text" id="zcode" name="zcode" size="25" title="Enter Zip Code"></td>
			    </tr>
			    ...
			    <tr/><tr/><tr/><tr/><tr/><tr/><tr/><tr/><tr/><tr/><tr/>
			     ...
			     <tr>
				<td align="right"> <span id="dep" class="form" ></span><label id="label8" for="department" class="detail">Department:</label></td>			
			    <td align="left"><input type="text" id="dept" name="dept" size="25" title="Enter your department"></td>
			    </tr>
